...
export default function Card({food}) {
    return (
        ...
        <div className="flex h-full">
            <div className="flex md:max-w-xl rounded-lg bg-white shadow-lg lg:container lg:mx-auto ">
            <img className=" object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg" src={food.image} alt="imgNotFound" />
